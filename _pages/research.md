...
In the photonic domain, Weyl points may enable the creation of [large-volume single-mode lasing devices](https://opg.optica.org/ol/abstract.cfm?URI=ol-39-7-2072). Furthermore, they can mediate [unique long-range interactions](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.125.163602) between embedded quantum emitters. However, due to fabrication challenges, experimental realization of photonic Weyl points at near-IR wavelengths has remained elusive.
<br/><br/>
